...
- [ ] **Step 3: проверить маршрутизацию**
...
- [ ] **Step 2: создать task packet template**
...
- [ ] **Step 3: проверить отсутствие неопределённости**
...
- [ ] **Step 1: описать архитектурные границы**
...
- [ ] **Step 2: описать security/privacy проверки**
...
- [ ] **Step 3: сверить со спецификацией**
...
- [ ] **Step 3: создать Definition of Done**
...
- [ ] **Step 4: вынести политику коммитов**
...
- [ ] **Step 1: написать failing probe для отсутствующего набора**
...
- [ ] **Step 3: связать README с AI workflow**
...
- [ ] **Step 2: выполнить полную проверку**
